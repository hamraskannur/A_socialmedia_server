        ...
        if (findUser) {
            if (findUser.verified === true) {
                ...
                if (passwordVerify) {
                    ...
                    if (!(findUser === null || findUser === void 0 ? void 0 : findUser.status)) {
                        res.status(200).send({
...
const getFriendsAccount = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const friendsAccount = yield userSchema_1.default.findOne({ _id: userId }).select('-password');
...
const updateUserData = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.body.userId;
        const user = yield userSchema_1.default.findOne({ username: req.body.username });
        if (!user || (user === null || user === void 0 ? void 0 : user._id.equals(new mongoose_1.default.Types.ObjectId(userId)))) {
...
const followUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (user === null || user === void 0 ? void 0 : user.public) {
            if (!((_a = user === null || user === void 0 ? void 0 : user.Followers) === null || _a === void 0 ? void 0 : _a.includes(userId))) {
            ...
            if ((_b = user === null || user === void 0 ? void 0 : user.Followers) === null || _b === void 0 ? void 0 : _b.includes(userId)) {
                ...
                if (!((_c = user === null || user === void 0 ? void 0 : user.Requests) === null || _c === void 0 ? void 0 : _c.includes(userId))) {
...
const getAllNotifications = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (user) {
            ...
            res.status(200).send({ Status: true, user: (_f = user[0]) === null || _f === void 0 ? void 0 : _f.notification });
        }
        else {
